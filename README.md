...
<img width="792" height="957" alt="image" src="https://github.com/user-attachments/assets/c0ad180e-6fb5-4c49-ae9e-4f5dd9d62439" />
...
class PeopleClassifier(nn.Module):
   def __init__(self, input_size):
    ...
    def forward(self, x):
        ...
        return x
# Training Loop
def train_model(jisha, train_loader, criterion, optimizer, epochs):
...
# Initialize model
jisha = PeopleClassifier(input_size=X_train.shape[1])
criterion = nn.CrossEntropyLoss()
optimizer = optim.Adam(jisha.parameters(), lr=0.001)

train_model(jisha, train_loader, criterion, optimizer, epochs=100)
...
print("Register No: 212224230106      ")
...
<img width="843" height="631" alt="image" src="https://github.com/user-attachments/assets/e47f11b9-4fbf-48fe-aff2-b4f69740bd55" />


### Classification Report

<img width="777" height="754" alt="image" src="https://github.com/user-attachments/assets/4beacf2e-d0ab-4e8e-bfcd-881302df22db" />


### New Sample Data Prediction

<img width="462" height="87" alt="image" src="https://github.com/user-attachments/assets/ba6f66b3-ddb0-453e-a137-5a3cd56b008b" />
